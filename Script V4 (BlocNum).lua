...
-- Quasi tutte le armi ont un "first shot kick", ovvero il primo colpo impenna molto più dei successivi,
...
function OnEvent(event, arg)
    ...
    if IsKeyLockOn("numlock") then -- Il BlocNum attiva lo script
